...
const StatCard = ({ title, value, icon: Icon, color, delay }) => (
  <motion.div
    ...
    className="bg-transparent/80 backdrop-blur-md bg-[#111111]/80 rounded-2xl border border-[#333333] border-[#333333] p-6 flex items-center gap-5"
  >
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-10">
            ...
            <motion.div
              ...
              className="bg-transparent/80 backdrop-blur-md bg-[#111111]/80 rounded-2xl border border-[#333333] border-[#333333] p-6 flex flex-col justify-center gap-2"
            >
