    ...
    return (
        <PageTransition>
            <div className="min-h-screen bg-[#050505] text-white">
                ...
                <div className="relative overflow-hidden pt-20 pb-32">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                        ...
                        >
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-100 to-gray-500">Connect with Experts.</span>
                        </motion.h1>
                        ...
                        >
                            ...
                            <Link to="/signup">
                                <motion.button
                                    whileHover={{ y: -2 }}
                                    whileTap={{ scale: 0.98 }}
                                    className="px-8 py-4 bg-transparent text-white font-bold rounded-2xl border border-gray-600 hover:bg-[#111111] transition-all"
                                >
                                    Join Now
                                </motion.button>
                            </Link>
                ...
                {/* Features / Quote */}
                <div className="py-20 bg-[#050505] border-t border-[#333333]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                            {[
                                ...
                                <motion.div
                                    key={idx}
                                    whileHover={{ y: -5 }}
                                    className="p-8 bg-[#111111] rounded-2xl border border-[#333333]"
                                >
                                    <div className="bg-[#1a1a1a] w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4">
                                        {feature.icon}
                                    </div>
                ...
                <div className="py-20 text-center">
                    <div className="max-w-4xl mx-auto px-4">
                        <blockquote className="text-3xl font-serif italic text-gray-700 text-gray-300">
