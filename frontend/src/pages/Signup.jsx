     ...
     <form className="mt-8 space-y-5" onSubmit={handleSignup}>
      <div className="flex gap-4">
       <div className="space-y-1 w-1/2">
        <label className="text-sm font-bold text-gray-700 text-gray-300">First Name</label>
        <input
         name="firstName"
         type="text"
         required
       ...
       <div className="space-y-1 w-1/2">
        <label className="text-sm font-bold text-gray-700 text-gray-300">Last Name</label>
        <input
         name="lastName"
         type="text"
         required
      ...
      <div className="space-y-1">
       <label className="text-sm font-bold text-gray-700 text-gray-300">Email</label>
      ...
      <div className="space-y-1">
       <label className="text-sm font-bold text-gray-700 text-gray-300">Password</label>
       <div className="relative">
        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
