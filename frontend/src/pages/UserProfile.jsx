                    ...
                    {activeExchange && (
                      <div className="mt-6">
                        <button
                          ...
                          className="w-full py-2.5 px-4 bg-white text-black font-bold hover:bg-gray-200 text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2"
                        >
                  ...
                  {userSkills.map((skill, index) => (
                    ...
                    >
                      <div className="p-6 flex flex-col h-full">
                        ...
                        <div className="mt-auto pt-4 border-t border-slate-100 border-[#333333]">
                          {activeExchange ? (
