   ...
   <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] p-4">
    ...
    >
     ...
     <form onSubmit={handleSubmit} className="space-y-6">
      <div>
       <label className="block text-sm font-bold text-gray-700 text-gray-300 mb-2">Email Address</label>
      ...
      <div>
       <label className="block text-sm font-bold text-gray-700 text-gray-300 mb-2">Password</label>
       <div className="relative">
        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
     ...
     <div className="mt-8 text-center text-sm text-gray-600 text-gray-400">
